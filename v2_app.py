...
def intro():
    ...
    st.markdown("""
This interactive tool is designed to aid students in preparing for the ISYE 6501 midterm II exam. Use this app to work through a variety of questions that cover course material effectively. The app includes:
