...
def intro():
    st.write("# Welcome to the ISYE 6501 Final Prep App! 👋")
    st.sidebar.success("Select a practice category to begin.")

    st.markdown("""
This interactive tool is designed to aid students in preparing for the ISYE 6501 Final exam. Use this app to work through a variety of questions that cover course material effectively. The app includes:
