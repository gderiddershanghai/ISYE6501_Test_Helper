...
midterm_2_q3 = """
Question A1: A retail company wants to optimize the layout of its warehouse to reduce the time it takes for workers to pick items for shipping. The layout optimization should consider the frequency of item requests and the physical distance between items.
...
midterm_2_q4 = """
Question A1: A healthcare provider aims to optimize its staff scheduling to ensure adequate coverage across various departments, taking into account staff availability, skills, and shift preferences.
